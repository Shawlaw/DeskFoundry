...
- Every product owns a distinct signing key. Keep the private key in a protected GitHub Environment/Secret, compile only its public key into the client, and have the release workflow verify the pair before publishing.
